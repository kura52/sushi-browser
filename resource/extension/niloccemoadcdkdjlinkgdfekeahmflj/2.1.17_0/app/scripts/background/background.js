/* globals $, PKT_EXT, log, isChromeOnly, chrome, sendMessageToTab, authentication, broadcastMessageToAllTabs,  isValidURL,  addMessageListener, getSetting, setSetting, openTabWithURL, isMac */
    ...
    function getFeatures(callback){
        ...
        PKT_EXT.API.getFeatures({
            success: function(response) {
                ...
                // console.log(recs, getSetting('recommendations'), response.features.show_recs)
        ...
        switch(request.action){
            ...
            case 'getSetup':
                ...
                if(!setupForce && typeof getSetting('setup') !== 'undefined'){
                    ...
                    log.debug(presetSetup.new_tab, pulse_check)
