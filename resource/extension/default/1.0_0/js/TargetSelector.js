...
// Modified in tools.js from selenium-IDE
    if(location.href != 'chrome-extension://dckpbojndfoinamcdamhkjhnjnmjkfjd/automation.html') {
      ...
      window.__targetSelector__ = new TargetSelector((element, win) => {
        if (element && win) {
          const selector = optCssSelector(element);
          chrome.ipcRenderer.send('select-target', false, selector);
          window.__targetSelector__.cleanup();
          window.__targetSelector__ = void 0;
        }
      }, _ => {
      });
    }
  ...
  /***/ (function(module, exports, __webpack_require__) {
    ...
    (function webpackUniversalModuleDefinition(root, factory) {
      if (true) module.exports = factory();else if (typeof define === 'function' && define.amd) define([], factory);else if (typeof exports === 'object') exports["OptimalSelect"] = factory();else root["OptimalSelect"] = factory();
    })(undefined, function () {
