...
chrome.storage.local.get(defaults, function (options) {
  ...
  function image(o) {
    if (o.width && o.height) {
      return chrome.runtime.getURL("data/images2/origin/both.svg")
    } else if (o.width) {
      return chrome.runtime.getURL("data/images2/origin/horizontal.svg")
    } else {
      return chrome.runtime.getURL("data/images2/origin/vertical.svg")
    }
  }
