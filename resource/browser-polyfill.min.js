(function (global, factory) {
  ...
  if (typeof browser === "undefined") {
    ...
    const wrapAPIs = () => {
      ...
      chrome.runtime._sendMessage = chrome.runtime.sendMessage
      chrome.runtime.sendMessage = (...args) =>{
        if(typeof(args[args.length-1]) !== "function"){
          args.push((response)=>{
            new Promise((resolve,reject)=>{
              console.log(333322343,response)
              resolve(response)
        ...
        chrome.runtime._sendMessage(...args)
      }
      ...
      chrome.runtime.onMessage.addListener = (callback) =>{
        if(!callback){
          callback = (message, sender, sendResponse)=>{
            new Promise((resolve,reject)=>{
              console.log(4545455,essage, sender, sendResponse)
              resolve(essage, sender, sendResponse)
              // else if (chrome.runtime.lastError) {
              //   reject(chrome.runtime.lastError)
              // }
              // else {
        ...
        chrome.runtime.onMessage._addListener(callback)
      }
      ...
      return wrapObject(targetObject, {}, apiMetadata);
    };
